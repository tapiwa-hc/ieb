...
router.delete('/groups/:id/:recursive', async (req, res, next) => {

  // db.groupsDelete(req.params.id, req.params.recursive)
  // .then(r => res.end())
  // .catch(e => {
  //   console.log(e);
...
router.get('/export/:date/:sections', async (req, res, next) => {
  try {
