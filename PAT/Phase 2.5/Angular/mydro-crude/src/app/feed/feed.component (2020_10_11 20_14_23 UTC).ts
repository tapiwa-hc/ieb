...
export class FeedComponent implements OnInit {
  ...
  constructor(private noticeService: NoticeService, private authService: AuthService, private route: ActivatedRoute, private router: Router) { }

  ngOnInit(): void {
    this.web = !this.router.url.includes('mobile')
    if (this.web) {
