...
import { pdfNotice } from './interfaces/pdf';
...
export class NoticeService {
  ...
  // Export
  exportToPDF(date, sections): Observable<pdfNotice[]> {
    return this.http.get<pdfNotice[]>(`${this.dbUrl}/export/${date}/${sections}`).pipe(
      catchError(this.handleError<pdfNotice[]>('exportToPDF', []))
    );
  }
