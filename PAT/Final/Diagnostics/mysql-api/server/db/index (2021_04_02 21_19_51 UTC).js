...
const pool = mysql.createPool({
  connectionLimit: 10,
  password: "ltS^Cf39Ppvr", // change MySQL password here
  user: "root", // change MySQL username here
...
db.deleteGroup = (id, recursive) => {
  return new Promise((resolve, reject) => {
    ...
    PROCEDURE pat_sandbox.groupsDeleteRecursive(IN _id TINYINT)
    BEGIN
      DELETE from notices
...
db.tagStudents = (noticeID, idsToMention) => {
  return new Promise((resolve, reject) => {
    ...
    /*
    CREATE DEFINER = 'root'@'localhost'
    PROCEDURE pat_sandbox.tagStudents(IN n_id SMALLINT, IN idsToAdd VARCHAR(255))
    BEGIN
...
db.addSubs = (userID, subsToAdd) => {
  return new Promise((resolve, reject) => {
    ...
    /* --MySQL Definition --
    CREATE DEFINER = 'root'@'localhost'
    PROCEDURE pat_sandbox.addSubs(IN u_id SMALLINT, IN idsToAdd VARCHAR(255))
    BEGIN
...
db.editNotice = (id, title, description, rights) => {
  return new Promise((resolve, reject) => {
    ...
    /* -- MySQL Definition --
    CREATE DEFINER = 'root'@'localhost'
    PROCEDURE pat_sandbox.editNotice(IN _notice_id VARCHAR(255), IN _title CHAR(100), IN _description VARCHAR(1000), IN _rights TINYINT)
    BEGIN
